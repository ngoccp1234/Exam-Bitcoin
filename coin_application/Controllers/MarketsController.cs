...
namespace coin_application.Controllers
{
    ...
    public class MarketsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MarketId,MarketName,Description,CreatedAt,UpdatedAt,Status")] Market market)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MarketId,MarketName,Description,CreatedAt,UpdatedAt,Status")] Market market)
        {
            if (ModelState.IsValid)
            {
